...
TARGET := appleMusic
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=appleMusic' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/appleMusic.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/appleMusic.node: LIBS := $(LIBS)
$(builddir)/appleMusic.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/appleMusic.node: TOOLSET := $(TOOLSET)
$(builddir)/appleMusic.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/appleMusic.node
# Add target alias
.PHONY: appleMusic
appleMusic: $(builddir)/appleMusic.node

# Short alias for building this executable.
.PHONY: appleMusic.node
appleMusic.node: $(builddir)/appleMusic.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/appleMusic.node
